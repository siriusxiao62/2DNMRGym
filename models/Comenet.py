...
#         z = data.z.long()
        ...
        ### TODO 
        # deal with when i and j are the same atom (data issue, or disconnected graph)
...
#             connected_hydrogens = [data.edge_index[1, e].item() for e in connected_edges if data.edge_index[1, e] in hydrogen_nodes]
